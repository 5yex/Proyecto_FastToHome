...
class Pedido extends Conexion{
    ...
    public function obtenerPedidosClientes() {
        $sql = "SELECT * FROM pedido WHERE id_usuario = :id_user AND (estado like 'enviando' or estado like 'pagado' 'en_preparacion'' OR estado like 'incidencia' ) order by id desc;";
