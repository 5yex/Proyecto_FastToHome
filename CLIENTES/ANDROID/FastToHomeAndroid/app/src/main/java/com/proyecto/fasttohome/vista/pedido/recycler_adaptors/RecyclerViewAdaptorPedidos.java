...
public class RecyclerViewAdaptorPedidos extends RecyclerView.Adapter<RecyclerViewAdaptorPedidos.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        private TextView fechaPedido, numeroPedido,estadoPedido,precioTotal;
            ...
            try {
                ...
                if ((resp.getBoolean("error")) == true) {
                    ...
                    for (int i = 0; i < arrayDeJson.length(); i++) {
                        ...
                        listaProductosCesta.add(product);
                    }
                    ...
                    for (Cesta product: listaProductosCesta) {
                        ...
                        lista.add(leftPad("€" + producto.getPrecio(), 5) +leftPad(" Uds: " + cantidad, 7) +"   Tot: " +leftPad("€" + precioTot, 5) + "  " + producto.getNombre());
                    }
