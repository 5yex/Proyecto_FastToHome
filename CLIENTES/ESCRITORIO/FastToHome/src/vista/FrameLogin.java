...
public class FrameLogin extends javax.swing.JFrame implements util.Constantes {
    ...
    public FrameLogin() {
        ...
        this.setIconImage(new ImageIcon(getClass().getResource("/recursos/logoIcon.png")));
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setMaximumSize(new java.awt.Dimension(245, 245));
        jLabel1.setMinimumSize(new java.awt.Dimension(245, 245));
        jLabel1.setPreferredSize(new java.awt.Dimension(245, 245));
