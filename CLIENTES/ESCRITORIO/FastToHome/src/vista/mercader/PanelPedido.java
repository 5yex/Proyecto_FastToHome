...
public class PanelPedido extends javax.swing.JPanel {
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(verMapa, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(jScrollPane2, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE)
                            .addComponent(pasarEstado, javax.swing.GroupLayout.DEFAULT_SIZE, 207, Short.MAX_VALUE))
    ...
    private void verMapaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_verMapaActionPerformed
       ...
       // String urlDireccion = "https://www.google.es/maps/@"+direccion.getCoordenadas()+",20z";
        
          String urlDireccion = " http://maps.google.com/maps?q="+direccion.getCoordenadas()+"&ll="+direccion.getCoordenadas()+"&z=20z";
                                                     ...
                                                     "\nNúmero: " + direccion.getNumero() + 
                                                      "\nCiudad: " + direccion.getCiudad() +
                                                       "\nCP: " + direccion.getCodigo_postal()+
                                                        "\nTeléfono: " + usuario_pedido.getTlf());
    ...
    public void cargarContenidoDeCesta(){
        ...
        for (Cesta elementoCesta : cesta) {
            ...
            listaModeloCesta.addElement(producto.getNombre()+ ", " + elementoCesta.getCantidad() + " unidades");
        }
        
        this.listaProductosDeCesta.setModel(listaModeloCesta);
